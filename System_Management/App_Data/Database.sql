...
CREATE TABLE UserToRoles(
     Id INT IDENTITY(10000,10),
     UserId INT NOT NULL,
     RoleId INT NOT NULL,
     CONSTRAINT "PK_UserToRoles" PRIMARY KEY 
	(
		"Id"
	),
	CONSTRAINT "FK_UserToRoles_Roles" FOREIGN KEY
	(
		"RoleId"
	...
	CONSTRAINT "FK_UserToRoles_User" FOREIGN KEY
	(
		"UserId"
...
CREATE TABLE RoleToPermissions(
	...
	CONSTRAINT "PK_RoleToPermissions" PRIMARY KEY
	(
		"Id"
	),
	CONSTRAINT "FK_RoleToPermissions_Roles" FOREIGN KEY
	(
		"RoleId"
	) REFERENCES "dbo"."Roles" 
	(
	...
	CONSTRAINT "FK_RoleToPermissions_Permission" FOREIGN KEY
	(
		"PermissionId"
...
CREATE TABLE SchoolHasUsers(
     Id BIGINT IDENTITY(100000,1),
     SchoolId INT NOT NULL,
     UserId INT NOT NULL,
     CONSTRAINT "PK__SchoolToStudents" PRIMARY KEY
	(
		"Id"
	),
	CONSTRAINT "FK_SchoolToStudents_Schools" FOREIGN KEY
	(
		"SchoolId"
	...
	CONSTRAINT "FK_SchoolToStudents_Users" FOREIGN KEY
	(
		"UserId"
	) REFERENCES "dbo"."Users" 
	(
...
GO
CREATE FUNCTION dbo.CheckUserRole(@UserId INT, @RoleId INT)
RETURNS BIT
AS
BEGIN
     DECLARE @Times INT
     DECLARE @Result BIT
     SET @Times = (SELECT COUNT(Id) FROM UserToRoles WHERE UserId = @UserId AND RoleId = @RoleId)
...
CREATE TABLE Admins(
	...
	CONSTRAINT "Check_Role_Admin" CHECK
	(
		"dbo".CheckUserRole(UserId,1) = 1
	)
)
...
--class in semester
CREATE TABLE SemesterOfStudents(
	Id INT IDENTITY(1000,1),
...
CREATE TABLE ClassOfStudents(
	...
	SemesterOfStudents INT NOT NULL,
	SubjectId INT NOT NULL,
	StartDate DATE DEFAULT GETDATE(),
	...
	(
		"SemesterOfStudents"
	) REFERENCES "dbo"."SemesterOfStudents" 
	(
		"Id"
	),
...
CREATE TABLE Applications(
	...
	(
     ...
     CONSTRAINT "FK_Application_ApplicationType" FOREIGN KEY
     (
          "Title"
...
---------------------------------END-APPLICATION---------------------------------
--------------------------------START-GRADE--------------------------------
CREATE TABLE GradeHasCategorys(
	Id INT IDENTITY(10000,1),
	SubjectId INT NOT NULL,
	CategoryName VARCHAR(100) NOT NULL,
	Weights NUMERIC(4,1) NOT NULL,
	CONSTRAINT "PK_GradeHasCategorys" PRIMARY KEY
	(
		"Id"
	),
	CONSTRAINT "FK_GradeHasCategorys_Subjects" FOREIGN KEY
	(
		"SubjectId"
	) REFERENCES "dbo"."Subjects" 
	(
...
CREATE TABLE GradeHasItems(
	Id INT IDENTITY(10000,1),
	CategoryId INT NOT NULL,
	ItemName VARCHAR(100) NOT NULL,
	Weights NUMERIC(4,1) NOT NULL,
	CONSTRAINT "PK_GradeHasItems" PRIMARY KEY
	(
		"Id"
	),
	...
	(
		"CategoryId"
	) REFERENCES "dbo"."GradeHasCategorys" 
	(
		"Id"
	)
)
...
CREATE TABLE Grades(
	...
	ClassOfStudent INT NOT NULL,
	Score NUMERIC(4,2)  NULL,
	CONSTRAINT "PK_Grades" PRIMARY KEY
	(
		"GradeId"
	),
	CONSTRAINT "FK_Grades_GradeHasItems" FOREIGN KEY
	(
		"GradeItems"
	) REFERENCES "dbo"."GradeHasItems" 
	(
		"Id"
	),
	...
	(
		"ClassOfStudent"
	) REFERENCES "dbo"."ClassOfStudents" 
	(
		"Id"
	)
)
...
CREATE TABLE ApplicationType(
     ...
     Cost MONEY NOT NULL DEFAULT 50000,
     CONSTRAINT "PK_ApplicationType" PRIMARY KEY(
          "Id"
     )
)
...
INSERT INTO Contacts VALUES('(024) 7300 5588','tuyensinh.hochiminh@fpt.edu.vn',N'Đại học FPT TP.HCM tọa lạc tại Lô E2a-7, Đường D1 Khu Công nghệ cao, P.Long Thạnh Mỹ, Q.9, TP.Hồ Chí Minh') 
INSERT INTO Contacts VALUES('(0236) 730 0999','tuyensinh.danang@fpt.edu.vn',N'Khu Đô Thị FPT Đà Nẵng, P. Hòa Hải, Q. Ngũ Hành Sơn, TP Đà Nẵng') 
INSERT INTO Contacts VALUES('0292 7303 636','tuyensinh.cantho@fpt.edu.vn',N'Cầu Rau Răm, đường Nguyễn Văn Cừ nối dài, An Bình, Ninh Kiều, Cần Thơ') 

GO
----------School----------
--SchoolId	SchoolName	SchoolContact
INSERT INTO Schools VALUES(N'FU - Hòa Lạc',10000)
INSERT INTO Schools VALUES(N'FU - Hồ Chí Minh',10001)
INSERT INTO Schools VALUES(N'FU - Đà Nẵng',10002)
INSERT INTO Schools VALUES(N'FU - Cần Thơ',10003)
...
---- Add the parameters for the stored procedure here
--	@UserName VARCHAR(50), @Password VARCHAR(100),@School INT,
--	@FirstName NVARCHAR(20), @MidleName NVARCHAR(20), @LastName NVARCHAR(20),
--	@Gender BIT, @DOB VARCHAR(20),
